...
- **Global VNet Peering**を構成した場合、Basic Load Balancer経由ではVMに接続できない。**Standard** を利用する必要がある。
...
![picture 2](images/a825d5e95e3fbb3390b4c1303114c9d3654ae13f688eafdcca3d72ff9e94e5f2.png)  
...
- MFA有効にするには、
  - MFAポータルを開く
  - 最低一つのverification methodを有効化
  - デバイスがMFAを記録するのを許可
  - conditional access policyを設定
